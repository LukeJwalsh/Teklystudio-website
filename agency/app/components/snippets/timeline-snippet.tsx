  ...
  const data = [
    {
      ...
      content: (
        <div className="max-w-xl">
          <p className="text-neutral-900 text-base md:text-2xl mb-4">
    ...
    },
    {
      ...
      content: (
        <div className="max-w-xl">
          <p className="text-neutral-900 text-base md:text-2xl max-w-xl">
    ...
    },
    {
      ...
      content: (
        <div className="max-w-xl">
          <p className="text-neutral-900 text-base md:text-2xl max-w-xl">
            Rigorous testing ensures quality and performance. We deploy your MVP to production and provide support for a smooth launch and early user feedback.
          </p>
          <Image
            src="/launch.png"
            alt="QA & Launch illustration"
            className="w-32 md:w-64 mx-auto"
            width={400}
            height={400}
          />
    ...
    },
    {
      ...
      content: (
        <div className="max-w-xl">
          ...
          <Image
            src="/iterate.png"
            alt="Iterate & Scale illustration"
            className="w-32 md:w-64 mx-auto"
            width={400}
            height={400}
          />
